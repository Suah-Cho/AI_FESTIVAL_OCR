...
DOC_TYPE_PRESETS: dict[str, DocTypePreset] = {
    "mixed_contract": DocTypePreset(
        ...
        doc_hint=(
            ...
            "- 성별, 생년월일, 국적\n"
            "- 생년월일은 신분증에서 먼저 확인하되, 판독이 어려우면 "
            "사업자등록증의 대표자 생년월일 등을 참고할 수 있습니다.\n"
            "- 신분증에 없는 항목은 빈 문자열.\n\n"
    ...
    "business_registration": DocTypePreset(
        ...
        doc_hint=(
            ...
            "- '생년월일'·'대표자 생년월일': 대표자 생년월일란이 있으면 그 값 "
            "(신분증 생년월일 확인 보조용으로도 사용)\n"
        ),
    ),
    "id_card": DocTypePreset(
        ...
        doc_hint=(
            ...
            "신분증에서 판독이 어려우면 사업자등록증의 대표자 생년월일을 참고하십시오.\n"
            "- '주소': 거주지 주소 전체\n"
